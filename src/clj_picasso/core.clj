...
(loading/save-image (basic-operations/resize image1 400 225)
                    "./resources/images/resized.png")
(loading/save-image (basic-operations/scale image1 2.0)
                    "./resources/images/scaled.png")
(loading/save-image (basic-operations/crop image1 200 200)
                    "./resources/images/cropped.png")
(loading/save-image (basic-operations/rotate image1 180)
                    "./resources/images/rotated.png")
(loading/save-image (basic-operations/mirror image1)
...
(loading/save-image (filters/apply-blur image1 5)
...
(loading/save-image (watermark/set-watermark-text image1 "Watermark" 175 200)
