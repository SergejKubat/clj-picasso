...
(loading/save-image (basic-operations/crop-image image1 100 100 200 200)
                    "./resources/images/cropped.png")
(loading/save-image (basic-operations/rotate-image image1 (/ Math/PI 2))
                    "./resources/images/rotated.png")
(loading/save-image (basic-operations/mirror-image image1)
                    "./resources/images/mirrored.png")
(loading/save-image (basic-operations/generate-random-image 250 250)
